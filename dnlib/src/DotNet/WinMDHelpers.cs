...
namespace dnlib.DotNet
{
    ...
    {
        private struct ClassName : IEquatable<ClassName>
        {
        ...
        // in a decompiler.
        private static readonly ProjectedClass[] ProjectedClasses = new ProjectedClass[] {
        ...
        private static readonly Dictionary<ClassName, ProjectedClass> winMDToCLR = new Dictionary<ClassName, ProjectedClass>();
        ...
        private static readonly Version invalidWinMDVersion = new Version(255, 255, 255, 255);
        ...
        private static readonly byte[] contractPublicKeyToken = new byte[] { 0xB0, 0x3F, 0x5F, 0x7F, 0x11, 0xD5, 0x0A, 0x3A };
        private static readonly byte[] neutralPublicKey = new byte[] { 0xb7, 0x7a, 0x5c, 0x56, 0x19, 0x34, 0xe0, 0x89 };
