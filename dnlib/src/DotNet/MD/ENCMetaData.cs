...
namespace dnlib.DotNet.MD
{
    ...
    /// </summary>
    internal sealed class ENCMetaData : MetaData
    {
        private static readonly UTF8String DeletedName = "_Deleted";
        private bool hasMethodPtr, hasFieldPtr, hasParamPtr, hasEventPtr, hasPropertyPtr;
        ...
        private uint LinearSearch_NoLock(MDTable tableSource, int keyColIndex, uint key)
        {
            if (tableSource == null)
                return 0;
            var keyColumn = tableSource.TableInfo.Columns[keyColIndex];
