...
namespace dnlib.DotNet.MD
{
    ...
    /// </summary>
    internal sealed class CompressedMetaData : MetaData
    {
        /// <inheritdoc/>
        ...
        private static string nativeImages40;

        private static HotHeapVersion GetHotHeapVersion(string fileName, string version)
        {
