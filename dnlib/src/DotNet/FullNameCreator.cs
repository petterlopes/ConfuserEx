...
namespace dnlib.DotNet
{
    ...
    public struct FullNameCreator
    {
        ...
        private readonly IFullNameCreatorHelper helper;
        ...
        private FullNameCreator(bool isReflection, IFullNameCreatorHelper helper)
        {
        ...
        private static string EscapeAssemblyName(UTF8String asmSimplName)
        {
            return EscapeAssemblyName(UTF8String.ToSystemString(asmSimplName));
        }

        private static string EscapeAssemblyName(string asmSimplName)
        {
        ...
        private int PrintMethodArgList(IEnumerable<TypeSig> args, bool hasPrintedArgs, bool isAfterSentinel)
        {
            if (args == null)
                return 0;
            if (isAfterSentinel)
