...
namespace dnlib.DotNet
{
    ...
    public class AssemblyResolver : IAssemblyResolver
    {
        ...
        private static readonly string[] winMDAssemblyExtensions = new string[] { ".winmd" };

        private static readonly List<GacInfo> gacInfos;
        private static readonly List<string> extraMonoPaths;
        ...
        private readonly ThreadSafe.IList<string> preSearchPaths = ThreadSafeListCreator.Create<string>();
        private readonly ThreadSafe.IList<string> postSearchPaths = ThreadSafeListCreator.Create<string>();
        private bool findExactMatch;
        private bool enableFrameworkRedirect;
        private bool enableTypeDefCache;
#if THREAD_SAFE
