...
namespace dnlib.DotNet
{
    ...
    {
        private TypeDef userType;
        private List<TypeDef> userTypeEnclosingTypes;
        private bool enclosingTypesInitialized;
        private Dictionary<IType, bool> baseTypes;
        private bool baseTypesInitialized;

        [Flags]
        private enum CheckTypeAccess
        {
            /// <summary>
        ...
        private CheckTypeAccess GetTypeAccess2(TypeDef td, GenericInstSig git)
        {
            while (td != null)
            {
        ...
        private bool IsSameAssemblyOrFriendAssembly(ModuleDef module)
        {
            if (module == null)
                return false;
        ...
        private static bool IsSameAssembly(IAssembly asm1, IAssembly asm2)
        {
        ...
        private List<TypeDef> InitializeOurEnclosingTypes()
        {
        ...
        private static List<TypeDef> GetEnclosingTypes(TypeDef td, bool includeInput)
        {
        ...
        private bool? CanAccess(FieldDef fd, GenericInstSig git)
        {
            if (fd == null)
                return null;
        ...
        private bool IsVisible(FieldDef fd, GenericInstSig git)
        {
            if (fd == null)
                return false;
        ...
        private bool? CanAccess(TypeDef td, MemberRef mr)
        {
        ...
        private bool? CanAccess(MethodDef md, MemberRef mr)
        {
            if (mr == null || md == null)
                return null;
            return CanAccess(md);
        ...
        private bool? CanAccess(ModuleRef mod, MemberRef mr)
        {
