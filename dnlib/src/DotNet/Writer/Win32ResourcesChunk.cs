...
namespace dnlib.DotNet.Writer
{
    ...
    public sealed class Win32ResourcesChunk : IChunk
    {
        ...
        private readonly Dictionary<IBinaryReader, uint> dataDict = new Dictionary<IBinaryReader, uint>();
        private readonly List<IBinaryReader> dataList = new List<IBinaryReader>();
        ...
        private const uint RESOURCE_DIR_ALIGNMENT = 4;
        private const uint RESOURCE_DATA_HEADER_ALIGNMENT = 4;
        private const uint RESOURCE_STRING_ALIGNMENT = 2;
        private const uint RESOURCE_DATA_ALIGNMENT = 4;
        ...
        private void AddData(IBinaryReader data)
        {
        ...
        private uint WriteTo(BinaryWriter writer, ResourceDirectory dir)
        {
        ...
        private uint WriteTo(BinaryWriter writer, ResourceData dataHeader)
        {
