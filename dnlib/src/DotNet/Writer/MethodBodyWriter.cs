...
namespace dnlib.DotNet.Writer
{
    ...
    {
        private readonly ITokenCreator helper;
        private readonly CilBody cilBody;
        ...
        private void WriteFatExceptionClauses(BinaryWriter writer)
        {
        ...
        private void WriteSmallExceptionClauses(BinaryWriter writer)
        {
