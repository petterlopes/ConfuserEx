...
namespace dnlib.DotNet.Writer
{
    ...
    {
        private const uint DEFAULT_IAT_ALIGNMENT = 4;
        private const uint DEFAULT_IMPORTDIRECTORY_ALIGNMENT = 4;
        private const uint DEFAULT_STARTUPSTUB_ALIGNMENT = 1;
        private const uint DEFAULT_RELOC_ALIGNMENT = 4;
