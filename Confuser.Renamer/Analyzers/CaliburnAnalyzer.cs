...
namespace Confuser.Renamer.Analyzers
{
    internal class CaliburnAnalyzer : IRenamer
    {
        ...
        private void AnalyzeMessageAttach(BAMLAnalyzer analyzer, Tuple<ISDnlibDef, AttributeInfoRecord, TypeDef> attr, string value)
        {
            if (attr.Item2 == null)
                return;
        ...
        private void AnalyzeAutoBind(BAMLAnalyzer analyzer, Tuple<ISDnlibDef, AttributeInfoRecord, TypeDef> attr, string value)
        {
        ...
        private void AnalyzeActionMessage(BAMLAnalyzer analyzer, Tuple<ISDnlibDef, AttributeInfoRecord, TypeDef> attr, string value)
        {
            if (attr.Item2 == null)
                return;
            var attrDeclType = analyzer.ResolveType(attr.Item2.OwnerTypeId);
