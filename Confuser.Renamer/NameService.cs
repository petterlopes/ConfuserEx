...
namespace Confuser.Renamer
{
    public interface INameService
    {
        ...
        void Analyze(ISDnlibDef def);

        bool CanRename(object obj);

        void SetCanRename(object obj, bool val);

        void SetParam(ISDnlibDef def, string name, string value);

        string GetParam(ISDnlibDef def, string name);
        ...
        void MarkHelper(ISDnlibDef def, IMarkerService marker, ConfuserComponent parentComp);
    }
    ...
    internal class NameService : INameService
    {
        ...
        {
            if (obj is ISDnlibDef)
            {
                if (analyze == null)
                    analyze = context.Pipeline.FindPhase<AnalyzePhase>();

                var prot = (NameProtection)analyze.Parent;
                ProtectionSettings parameters = ProtectionParameters.GetParameters(context, (ISDnlibDef)obj);
