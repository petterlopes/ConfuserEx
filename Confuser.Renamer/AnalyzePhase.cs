...
namespace Confuser.Renamer
{
    internal class AnalyzePhase : ProtectionPhase
    {
        ...
        protected override void Execute(ConfuserContext context, ProtectionParameters parameters)
        {
            ...
            foreach (ISDnlibDef def in parameters.Targets.WithProgress(context.Logger))
            {
        ...
        internal void Analyze(NameService service, ConfuserContext context, ProtectionParameters parameters, ISDnlibDef def, bool runAnalyzer)
        {
            if (def is TypeDef)
