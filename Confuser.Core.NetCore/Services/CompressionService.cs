using Confuser.Core.NetCore.Helpers;
using SevenZip;
...
namespace Confuser.Core.NetCore.Services
{
    internal class CompressionService : ICompressionService
    {
        ...
        /// <inheritdoc />
        public MethodDef TryGetRuntimeDecompressor(ModuleDef module, Action<ISDnlibDef> init)
        {
            var decompressor = context.Annotations.Get<Tuple<MethodDef, List<ISDnlibDef>>>(module, Decompressor);
    ...
    public interface ICompressionService
    {
        ...
        /// </returns>
        MethodDef TryGetRuntimeDecompressor(ModuleDef module, Action<ISDnlibDef> init);
        ...
        MethodDef GetRuntimeDecompressor(ModuleDef module, Action<ISDnlibDef> init);
