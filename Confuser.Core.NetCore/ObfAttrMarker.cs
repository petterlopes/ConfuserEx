using Confuser.Core.NetCore.Project;
using Confuser.Core.NetCore.Project.Patterns;
using System;
...
namespace Confuser.Core.NetCore
{
    ...
    public class ObfAttrMarker : Marker
    {
        ...
        private class ProtectionSettingsStack
        {
            ...
            private readonly Stack<Tuple<ProtectionSettings, ProtectionSettingsInfo[]>> stack;
            ...
            {
                private ProtectionSettingsStack parent;
        ...
        private bool ToInfo(ObfuscationAttributeInfo attr, out ProtectionSettingsInfo info)
        {
        ...
        private IEnumerable<ProtectionSettingsInfo> ReadInfos(IHasCustomAttribute item)
        {
        ...
        private ProtectionSettingsInfo AddRule(ObfuscationAttributeInfo attr, List<ProtectionSettingsInfo> infos)
        {
        ...
        private void MarkModule(ProjectModule projModule, ModuleDefMD module, Rules rules, bool isMain)
        {
        ...
        private void ProcessModule(ModuleDefMD module, ProtectionSettingsStack stack)
        {
        ...
        private void ProcessTypeMembers(TypeDef type, ProtectionSettingsStack stack)
        {
        ...
        private void ProcessBody(MethodDef method, ProtectionSettingsStack stack)
        {
