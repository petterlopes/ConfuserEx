...
namespace Confuser.Core.NetCore.Project
{
    /// <summary>
    ...
    public class ConfuserProject : List<ProjectModule>
    {
        ...
        /// </summary>
        public static readonly XmlSchema Schema = XmlSchema.Read(typeof(ConfuserProject).Assembly.GetManifestResourceStream("Confuser.Core.NetCore.Project.ConfuserPrj.xsd"), null);
