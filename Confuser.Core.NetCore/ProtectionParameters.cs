...
namespace Confuser.Core.NetCore
{
    ...
    public class ProtectionParameters
    {
        ...
        /// </summary>
        public static readonly ProtectionParameters Empty = new ProtectionParameters(null, new ISDnlibDef[0]);
        ...
        internal ProtectionParameters(ConfuserComponent component, IList<ISDnlibDef> targets)
        {
            comp = component;
            Targets = targets;
        }
        ...
        public IList<ISDnlibDef> Targets { get; private set; }
