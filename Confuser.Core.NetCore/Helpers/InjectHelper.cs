...
namespace Confuser.Core.NetCore.Helpers
{
    /// <summary>
    ...
    public static class InjectHelper
    {
        ...
        public static IEnumerable<ISDnlibDef> Inject(TypeDef typeDef, TypeDef newType, ModuleDef target)
        {
            var ctx = new InjectContext(typeDef.Module, target);
        ...
        private class InjectContext : ImportResolver
        {
            ...
            /// </summary>
            public readonly Dictionary<ISDnlibDef, ISDnlibDef> Map = new Dictionary<ISDnlibDef, ISDnlibDef>();
