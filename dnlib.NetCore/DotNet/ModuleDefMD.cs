...
using DNW = dnlib.NetCore.DotNet.Writer;
...
namespace dnlib.NetCore.DotNet
{
    ...
    public sealed class ModuleDefMD : ModuleDefMD2, IInstructionOperandResolver, ISignatureReaderHelper
    {
        ...
        private RandomRidList moduleRidList;
        ...
        private static ImageLayout GetImageLayout(System.Reflection.Module mod)
        {
        ...
        private ModuleDefMD(MetaData metaData, ModuleCreationOptions options)
            : base(null, 1)
        {
#if DEBUG
            if (metaData == null)
        ...
        private ISymbolReader CreateSymbolReader(ModuleCreationOptions options)
        {
        ...
        private CilBody InitializeBodyFromPdb(CilBody body, uint rid)
        {
            if (pdbState != null)
