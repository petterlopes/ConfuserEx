...
namespace dnlib.NetCore.DotNet
{
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.ValueType"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.Class"/>
    /// </summary>
    ...
    public abstract class GenericSig : LeafSig
    {
        ...
        /// <summary>
        /// Gets the corresponding <see cref="dnlib.NetCore.DotNet.GenericParam"/> or <c>null</c> if none exists.
        /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.Var"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.MVar"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.Sentinel"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.FnPtr"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.GenericInst"/>
    /// </summary>
    public sealed class GenericInstSig : LeafSig
    {
        private ClassOrValueTypeSig genericType;
        private readonly ThreadSafe.IList<TypeSig> genericArgs;
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.Ptr"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.ByRef"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.Array"/>
    /// </summary>
    /// <seealso cref="SZArraySig"/>
    public sealed class ArraySig : ArraySigBase
    {
        private uint rank;
        private readonly ThreadSafe.IList<uint> sizes;
        private readonly ThreadSafe.IList<int> lowerBounds;
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.SZArray"/> (single dimension, zero lower bound array)
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.CModReqd"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.CModOpt"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.Pinned"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.ValueArray"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="dnlib.NetCore.DotNet.ElementType.Module"/>
    /// </summary>
