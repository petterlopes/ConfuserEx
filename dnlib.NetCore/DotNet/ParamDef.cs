...
namespace dnlib.NetCore.DotNet
{
    ...
    public abstract class ParamDef : IHasConstant, IHasCustomAttribute, IHasFieldMarshal
    {
        ...
        /// <summary>
        /// Gets the constant element type or <see cref="dnlib.NetCore.DotNet.ElementType.End"/> if there's no constant
        /// </summary>
    ...
    /// </summary>
    internal sealed class ParamDefMD : ParamDef, IMDTokenProviderMD
    {
