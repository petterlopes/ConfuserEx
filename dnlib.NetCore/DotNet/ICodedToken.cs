...
namespace dnlib.NetCore.DotNet
{
    ...
    {
        /// <summary>
        /// It's an <see cref="dnlib.NetCore.DotNet.AssemblyRef"/> instance
        /// </summary>
        AssemblyRef,

        /// <summary>
        /// It's a <see cref="dnlib.NetCore.DotNet.ModuleRef"/> instance
        /// </summary>
        ModuleRef,

        /// <summary>
        /// It's a <see cref="dnlib.NetCore.DotNet.ModuleDef"/> instance
        /// </summary>
        ModuleDef,
    }
    ...
    /// </summary>
    public interface IMemberDef : ISDnlibDef, IMemberRef
    {
        /// <summary>
        /// Gets the declaring type
        /// </summary>
    ...
    /// </summary>
    public interface ISDnlibDef : ICodedToken, IFullName, IHasCustomAttribute
    {
    }
