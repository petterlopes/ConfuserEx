...
namespace dnlib.NetCore.DotNet.Writer
{
    ...
    public abstract class HotTable : IChunk
    {
        ...
        private readonly HotHeapVersion version;
        private readonly int hotTableHeaderSize;
        ...
        /// </summary>
        private uint CalculateFullTableLength()
        {
        ...
        private void InitializePartialData()
        {
            if (partialData != null)
                return;
        ...
        private void FullWriteTo(BinaryWriter writer)
        {
            CreateFullData();
        ...
        private static int CountMaxBits(uint val)
        {
            int bits = 0;
            while (val != 0)
            {
        ...
        private void InitializePartialRids()
        {
        ...
        private void CreateFirstAndSecondLevelTables()
        {
    ...
    public sealed class HotTable40 : HotTable
    {
        ...
        private void WriteIndexesTable(BinaryWriter writer)
        {
