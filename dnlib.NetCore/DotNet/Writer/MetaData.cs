...
namespace dnlib.NetCore.DotNet.Writer
{
    ...
    public sealed class MetaDataOptions
    {
        ...
        private List<IHeap> otherHeaps;
        private List<IHeap> otherHeapsEnd;
    ...
    public abstract class MetaData : IChunk, ISignatureWriterHelper, ITokenCreator, ICustomAttributeWriterHelper
    {
        ...
        private IMetaDataListener listener;
        ...
        /// </summary>
        private void WriteTypeDefAndMemberDefCustomAttributes()
        {
            int numTypes = allTypeDefs.Count;
            int typeNum = 0;
            int notifyNum = 0;
        ...
        /// </summary>
        private void InitializeCustomAttributeTable()
        {
        ...
        private const uint HEAP_ALIGNMENT = 4;
