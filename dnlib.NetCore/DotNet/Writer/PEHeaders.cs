...
namespace dnlib.NetCore.DotNet.Writer
{
    ...
    public sealed class PEHeadersOptions
    {
        ...
        /// </summary>
        public const DllCharacteristics DefaultDllCharacteristics = dnlib.NetCore.PE.DllCharacteristics.TerminalServerAware | dnlib.NetCore.PE.DllCharacteristics.NoSeh | dnlib.NetCore.PE.DllCharacteristics.NxCompat | dnlib.NetCore.PE.DllCharacteristics.DynamicBase;

        /// <summary>
        /// Default subsystem value
        /// </summary>
        public const Subsystem DEFAULT_SUBSYSTEM = dnlib.NetCore.PE.Subsystem.WindowsGui;
        ...
        /// <summary>
        /// IMAGE_FILE_HEADER.Characteristics value. <see cref="dnlib.NetCore.PE.Characteristics.Dll"/> bit
    ...
    public sealed class PEHeaders : IChunk
    {
        ...
        private static readonly byte[] dosHeader = new byte[0x80] {
