...
namespace dnlib.NetCore.DotNet.Writer
{
    ...
    public abstract class HotPool : IChunk
    {
        ...
        private Dictionary<uint, byte[]> allData;
        ...
        private static void Shuffle<T>(Random rand, IList<T> list, int start, int count)
        {
    ...
    /// </summary>
    internal sealed class HotPool20 : HotPool
    {
        /// <summary>
        /// Constructor
        /// </summary>
    ...
    /// </summary>
    internal sealed class HotPool40 : HotPool
    {
        /// <summary>
        /// Constructor
        /// </summary>
