...
namespace dnlib.NetCore.DotNet.Emit
{
    ...
    public class DynamicMethodBodyReader : MethodBodyReaderBase, ISignatureReaderHelper
    {
        ...
        {
            private SR.FieldInfo fieldInfo;
        ...
        private MethodDef CreateMethodDef(SR.MethodBase delMethod)
        {
            bool isStatic = true;
        ...
        private TypeSig GetReturnType(SR.MethodBase mb)
        {
        ...
        private List<TypeSig> GetParameters(SR.MethodBase delMethod)
        {
        ...
        private SR.MethodInfo GetVarArgMethod(object obj)
        {
