...
namespace dnlib.NetCore.DotNet.Emit
{
    ...
    public sealed class Instruction
    {
        ...
        private void CalculateStackUsageCall(OpCode opCode, out int pushes, out int pops)
        {
            pushes = 0;
            pops = 0;
    ...
    static partial class Extensions
    {
        ...
        /// <param name="self">this</param>
        /// <returns></returns>
        public static dnlib.NetCore.DotNet.Pdb.SequencePoint GetSequencePoint(this Instruction self)
        {
