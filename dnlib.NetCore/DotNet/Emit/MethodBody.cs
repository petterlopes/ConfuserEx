...
namespace dnlib.NetCore.DotNet.Emit
{
    ...
    public sealed class CilBody : MethodBody
    {
        ...
        private readonly ThreadSafe.IList<Instruction> instructions;
        private readonly ThreadSafe.IList<ExceptionHandler> exceptionHandlers;
        private readonly LocalList localList;
        private PdbScope pdbScope;
