...
namespace dnlib.NetCore.DotNet.Emit
{
    ...
    public sealed class MethodBodyReader : MethodBodyReaderBase
    {
        ...
        private IBinaryReader exceptionsReader;
        ...
        /// </summary>
        private void ReadExceptionHandlers()
        {
            if ((flags & 8) == 0)
                return;
        ...
        private void ReadFatExceptionHandlers(IBinaryReader ehReader)
        {
            ehReader.Position--;
        ...
        private void ReadSmallExceptionHandlers(IBinaryReader ehReader)
        {
