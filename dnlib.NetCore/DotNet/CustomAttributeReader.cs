...
namespace dnlib.NetCore.DotNet
{
    ...
    public struct CustomAttributeReader : IDisposable
    {
        ...
        private CustomAttributeReader(ModuleDef module, IBinaryReader reader, GenericParamContext gpContext)
        {
            this.module = module;
            this.reader = reader;
        ...
        private CustomAttributeReader(ModuleDef module, IBinaryReader reader, bool ownRerader, GenericParamContext gpContext)
        {
            this.module = module;
            this.reader = reader;
        ...
        private static IBinaryReader CloneBlobReader(IBinaryReader reader)
        {
            if (reader == null)
                return null;
