...
namespace dnlib.NetCore.DotNet
{
    ...
    public sealed class Parameter : IVariable
    {
        ...
        /// <summary>
        /// Gets the <see cref="dnlib.NetCore.DotNet.ParamDef"/> or <c>null</c> if not present
        /// </summary>
        ...
        /// <summary>
        /// <c>true</c> if it has a <see cref="dnlib.NetCore.DotNet.ParamDef"/>
        /// </summary>
        ...
        /// <summary>
        /// Creates a <see cref="dnlib.NetCore.DotNet.ParamDef"/> if it doesn't already exist
        /// </summary>
