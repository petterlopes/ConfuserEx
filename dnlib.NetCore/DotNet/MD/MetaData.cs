...
namespace dnlib.NetCore.DotNet.MD
{
    ...
    internal abstract class MetaData : IMetaData
    {
        ...
        private Dictionary<uint, RandomRidList> typeDefRidToNestedClasses;
        private RandomRidList nonNestedTypes;
        ...
        protected sealed class SortedTable
        {
            ...
            private struct RowInfo : IComparable<RowInfo>
            {
        ...
        private static void Dispose(IDisposable id)
        {
            if (id != null)
                id.Dispose();
        }
