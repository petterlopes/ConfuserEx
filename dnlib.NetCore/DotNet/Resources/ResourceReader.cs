...
namespace dnlib.NetCore.DotNet.Resources
{
    /// <summary>
    ...
    public struct ResourceReader
    {
        ...
        private readonly long baseFileOffset;
        private readonly ResourceDataCreator resourceDataCreator;
        ...
        private static uint ReadUInt32(IBinaryReader reader)
        {
            try
            {
