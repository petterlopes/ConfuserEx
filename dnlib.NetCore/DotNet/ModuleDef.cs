...
namespace dnlib.NetCore.DotNet
{
    ...
    /// </summary>
    public abstract class ModuleDef : IHasCustomAttribute, IResolutionScope, IDisposable, IListListener<TypeDef>, IModule, ITypeDefFinder, ISDnlibDef, ITokenResolver
    {
        ...
        /// <summary>
        /// Gets/sets a user value. This is never used by dnlib.NetCore. This property isn't thread safe.
        /// </summary>
        public object Tag
        {
            get { return tag; }
        ...
        /// <summary>
        /// Gets the <see cref="dnlib.NetCore.DotNet.Pdb.PdbState"/>. This is <c>null</c> if no PDB file
        ...
        /// <summary>
        /// <c>true</c> if <see cref="Machine"/> is <see cref="dnlib.NetCore.PE.Machine.I386"/>
        /// </summary>
        public bool IsI386
        {
        ...
        /// <summary>
        /// <c>true</c> if <see cref="Machine"/> is <see cref="dnlib.NetCore.PE.Machine.IA64"/>
        /// </summary>
        public bool IsIA64
        {
        ...
        /// <summary>
        /// <c>true</c> if <see cref="Machine"/> is <see cref="dnlib.NetCore.PE.Machine.AMD64"/>
        /// </summary>
        public bool IsAMD64
        {
        ...
        /// <summary>
        /// <c>true</c> if <see cref="Machine"/> is <see cref="dnlib.NetCore.PE.Machine.ARM64"/>
        /// </summary>
        public bool IsARM64
        {
        ...
        /// <summary>
        /// Creates a new <see cref="dnlib.NetCore.DotNet.Pdb.PdbState"/>
        /// </summary>
        ...
        /// <summary>
        /// Sets a <see cref="dnlib.NetCore.DotNet.Pdb.PdbState"/>
        /// </summary>
        /// <param name="pdbState">New <see cref="dnlib.NetCore.DotNet.Pdb.PdbState"/></param>
