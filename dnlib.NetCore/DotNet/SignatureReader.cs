...
namespace dnlib.NetCore.DotNet
{
    ...
    public interface ISignatureReaderHelper
    {
        ...
        /// </summary>
        /// <seealso cref="dnlib.NetCore.DotNet.Emit.MethodTableToTypeConverter"/>
    ...
    public struct SignatureReader : IDisposable
    {
        ...
        /// <param name="gpContext">Generic parameter context</param>
        private SignatureReader(ISignatureReaderHelper helper, ICorLibTypes corLibTypes, IBinaryReader reader, GenericParamContext gpContext)
        {
            this.helper = helper;
