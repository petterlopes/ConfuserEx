...
namespace dnlib.NetCore.Utils
{
    ...
    public class LazyList<TValue> : ILazyList<TValue> where TValue : class
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private readonly MFunc<object, uint, TValue> readOriginalValue;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private readonly IListListener<TValue> listener;
        ...
        private sealed class LazyElement : Element
        {
            ...
            private LazyList<TValue> lazyList;
        ...
        private TValue ReadOriginalValue_NoLock(int index, uint origIndex)
        {
