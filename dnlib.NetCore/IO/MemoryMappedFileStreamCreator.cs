...
namespace dnlib.NetCore.IO
{
    ...
    internal sealed class MemoryMappedFileStreamCreator : UnmanagedMemoryStreamCreator
    {
        ...
        private static bool canTryWindows = true;
        private static bool canTryUnix = true;
